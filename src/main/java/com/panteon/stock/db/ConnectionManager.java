...
public class ConnectionManager {
    ...
    private static volatile ConnectionManager instance = null; // not for caching
    ...
    private void registerOurDriver() {
        try {
        ...
        if (connection == null) {
            try {
                connection = DriverManager.getConnection(getDataSource().getConnectionUrl(),
                        getDataSource().getLogin(), getDataSource().getPassword());
            } catch (SQLException e) {
